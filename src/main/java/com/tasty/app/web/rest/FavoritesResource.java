...
/**
 * REST controller for managing {@link com.tasty.app.domain.Favorites}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class FavoritesResource {
    ...
    public ResponseEntity<Favorites> updateFavorites(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, favorites.getId().toString()))
            .body(result);
    }
    ...
    public ResponseEntity<Favorites> partialUpdateFavorites(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, favorites.getId().toString())
        );
    }
