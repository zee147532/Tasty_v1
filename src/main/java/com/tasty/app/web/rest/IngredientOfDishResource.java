...
public class IngredientOfDishResource {
    ...
    public IngredientOfDishResource(IngredientOfDishRepository ingredientOfDishRepository) {
    ...
    public ResponseEntity<IngredientOfDish> createIngredientOfDish(@RequestBody IngredientOfDish ingredientOfDish)
        ...
        IngredientOfDish result = ingredientOfDishRepository.save(ingredientOfDish);
    ...
    public ResponseEntity<IngredientOfDish> partialUpdateIngredientOfDish(
        ...
        Optional<IngredientOfDish> result = ingredientOfDishRepository
    ...
    public ResponseEntity<List<IngredientOfDish>> getAllIngredientOfDishes(
        ...
        Page<IngredientOfDish> page = ingredientOfDishRepository.findAll(pageable);
    ...
    public ResponseEntity<IngredientOfDish> getIngredientOfDish(@PathVariable Long id) {
        ...
        Optional<IngredientOfDish> ingredientOfDish = ingredientOfDishRepository.findById(id);
