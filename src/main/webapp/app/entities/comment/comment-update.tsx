...
export const CommentUpdate = () => {
  ...
  const saveEntity = values => {
    const entity = {
      ...commentEntity,
      ...values,
      supperComment: comments.find(it => it.id.toString() === values.supperComment.toString()),
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...
          supperComment: commentEntity?.supperComment?.id,
        };
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="tastyV1App.comment.home.createOrEditLabel" data-cy="CommentCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label="Is Sub Comment"
                id="comment-isSubComment"
                name="isSubComment"
                data-cy="isSubComment"
                check
                type="checkbox"
              />
              ...
              <ValidatedField id="comment-supperComment" name="supperComment" data-cy="supperComment" label="Supper Comment" type="select">
                <option value="" key="0" />
                {comments
