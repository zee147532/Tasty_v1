          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('isSubComment')}>
                  Is Sub Comment <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th>
                  Supper Comment <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {commentList.map((comment, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{comment.isSubComment ? 'true' : 'false'}</td>
                  <td>{comment.comment}</td>
                  <td>{comment.post ? <Link to={`/post/${comment.post.id}`}>{comment.post.id}</Link> : ''}</td>
                  <td>
                    {comment.supperComment ? <Link to={`/comment/${comment.supperComment.id}`}>{comment.supperComment.id}</Link> : ''}
                  </td>
