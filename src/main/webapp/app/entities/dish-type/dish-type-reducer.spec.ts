...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './dish-type.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DISHTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_DISHTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DISHTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DISHTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DISHTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DISHTYPE actions', async () => {
      const expectedActions = [
        {
