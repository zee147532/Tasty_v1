...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './ingredient-of-dish.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INGREDIENTOFDISH_LIST actions', async () => {
    ...
    it('dispatches FETCH_INGREDIENTOFDISH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INGREDIENTOFDISH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INGREDIENTOFDISH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INGREDIENTOFDISH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INGREDIENTOFDISH actions', async () => {
      const expectedActions = [
        {
