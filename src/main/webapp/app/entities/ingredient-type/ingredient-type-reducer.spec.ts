...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INGREDIENTTYPE_LIST actions', async () => {
    ...
    it('dispatches FETCH_INGREDIENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INGREDIENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INGREDIENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INGREDIENTTYPE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INGREDIENTTYPE actions', async () => {
      const expectedActions = [
        {
