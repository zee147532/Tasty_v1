            ...
            <tbody>
              {postList.map((post, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{post.author ? <Link to={`/customer/${post.author.id}`}>{post.author.id}</Link> : ''}</td>
                  <td>{post.supperComment ? <Link to={`/post/${post.supperComment.id}`}>{post.supperComment.id}</Link> : ''}</td>
