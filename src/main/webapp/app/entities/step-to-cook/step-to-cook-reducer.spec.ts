...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STEPTOCOOK_LIST actions', async () => {
    ...
    it('dispatches FETCH_STEPTOCOOK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STEPTOCOOK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STEPTOCOOK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STEPTOCOOK actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STEPTOCOOK actions', async () => {
      const expectedActions = [
        {
