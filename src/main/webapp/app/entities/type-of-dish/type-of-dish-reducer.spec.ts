...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TYPEOFDISH_LIST actions', async () => {
    ...
    it('dispatches FETCH_TYPEOFDISH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TYPEOFDISH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TYPEOFDISH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TYPEOFDISH actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TYPEOFDISH actions', async () => {
      const expectedActions = [
        {
