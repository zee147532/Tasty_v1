...
class CommentResourceIT {
    ...
    private static final Boolean DEFAULT_IS_SUB_COMMENT = false;
    private static final Boolean UPDATED_IS_SUB_COMMENT = true;
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().isSubComment(DEFAULT_IS_SUB_COMMENT).comment(DEFAULT_COMMENT);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().isSubComment(UPDATED_IS_SUB_COMMENT).comment(UPDATED_COMMENT);
        return comment;
    }
    ...
    void createComment() throws Exception {
        ...
        assertThat(testComment.getIsSubComment()).isEqualTo(DEFAULT_IS_SUB_COMMENT);
    ...
    void getAllComments() throws Exception {
        ...
        restCommentMockMvc
            ...
            .andExpect(jsonPath("$.[*].isSubComment").value(hasItem(DEFAULT_IS_SUB_COMMENT.booleanValue())))
    ...
    void getComment() throws Exception {
        ...
        restCommentMockMvc
            ...
            .andExpect(jsonPath("$.isSubComment").value(DEFAULT_IS_SUB_COMMENT.booleanValue()))
    ...
    void putExistingComment() throws Exception {
        ...
        updatedComment.isSubComment(UPDATED_IS_SUB_COMMENT).comment(UPDATED_COMMENT);
        ...
        Comment testComment = commentList.get(commentList.size() - 1);
        assertThat(testComment.getIsSubComment()).isEqualTo(UPDATED_IS_SUB_COMMENT);
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.isSubComment(UPDATED_IS_SUB_COMMENT);
    ...
    void fullUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.isSubComment(UPDATED_IS_SUB_COMMENT).comment(UPDATED_COMMENT);
