...
class IngredientResourceIT {
    ...
    public static Ingredient createEntity(EntityManager em) {
        Ingredient ingredient = new Ingredient().name(DEFAULT_NAME).otherName(DEFAULT_OTHER_NAME);
        return ingredient;
    }
    ...
    public static Ingredient createUpdatedEntity(EntityManager em) {
        Ingredient ingredient = new Ingredient().name(UPDATED_NAME).otherName(UPDATED_OTHER_NAME);
        return ingredient;
    }
    ...
    void createIngredient() throws Exception {
        ...
        assertThat(testIngredient.getOtherName()).isEqualTo(DEFAULT_OTHER_NAME);
    }
    ...
    void putExistingIngredient() throws Exception {
        ...
        updatedIngredient.name(UPDATED_NAME).otherName(UPDATED_OTHER_NAME);
        ...
        assertThat(testIngredient.getOtherName()).isEqualTo(UPDATED_OTHER_NAME);
    }
    ...
    void partialUpdateIngredientWithPatch() throws Exception {
        ...
        partialUpdatedIngredient.name(UPDATED_NAME).otherName(UPDATED_OTHER_NAME);
